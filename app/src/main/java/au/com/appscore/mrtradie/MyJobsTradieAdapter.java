...
/**
 * Created by adityathakar on 10/09/15.
 */
public class MyJobsTradieAdapter extends BaseAdapter {
    Context context;
    JSONArray jsonArrayRecords;

    public MyJobsTradieAdapter(Context context, JSONArray jsonArrayRecords) {
