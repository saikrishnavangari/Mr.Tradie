 ...
 */
public class MyQuotesCustomerAdapter extends BaseAdapter {

    Context context;
    JSONArray jsonArrayRecords;

    public MyQuotesCustomerAdapter(Context context,JSONArray jsonArrayRecords) {
...
//                        Intent intent = new Intent(context, CustomerQuoteRepliedScreen.class);
//                        try {
